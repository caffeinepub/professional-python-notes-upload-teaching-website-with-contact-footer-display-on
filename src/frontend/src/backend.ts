...
import type { ExternalBlob as _ExternalBlob, Note as _Note, NoteType as _NoteType, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPdfNote(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPdfNote(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTextNote(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createTextNote(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadPdfNote(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.downloadPdfNote(arg0);
    ...
    async viewNote(arg0: string): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.viewNote(arg0);
...
async function from_candid_NoteType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _NoteType): Promise<NoteType> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        content: await from_candid_NoteType_n13(_uploadFile, _downloadFile, value.content)
    };
}
...
async function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pdf" in value ? {
        __kind__: "pdf",
        pdf: await from_candid_ExternalBlob_n9(_uploadFile, _downloadFile, value.pdf)
    } : "text" in value ? {
        __kind__: "text",
        text: value.text
    } : value;
